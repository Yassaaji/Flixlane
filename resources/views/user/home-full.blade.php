                ...
                @foreach ($films as $fl)
                  <div class="banner-wrap justify-content-between align-items-center">
                    <div class="left-wrap">
                      ...
                      <span class="tag"></span>
                      <p>{{ $fl->sinopsis }}</p>
                      <a href="{{ url('/video/' . $fl->id) }}" class="btn btn-lg"><img src="/images/play.png" alt="icn">Watch now</a>
                    </div>
                    <div class="right-wrap"><img src="{{ asset('storage/tumnile/' . $fl->thumbnile) }}" alt=""></div>
                  </div>
                </div>
                @endforeach
            </div>
            ...
            <div class="slide-slider-full owl-carousel owl-theme owl-loaded owl-drag">
              <div class="owl-stage-outer">
                  ...
                  <div class="owl-item cloned" style="width: 401.11px; margin-right: 15px;">
                    <div class="owl-items">
                        <a class="slide-one" href="{{ url('/video/' . $fl->id) }}">
                        <div class="slide-image"><img src="{{ asset('storage/tumnile/' . $fl->thumbnile) }}" style="height: 300px;" alt="image"></div>
                        <div class="slide-content">
                          <h2>{{ $fl->judul }} <img src="images/plus.png" alt="icon"></h2>
                          <p>{{ $fl->sinopsis }}</p>
                          <span class="tag">{{ $fl->durasi }}</span>
                      <span class="tag">{{ $fl->tayang }}</span>
                      <span class="tag"><b>{{ $fl->minimal_usia }}+</b></span>
